...
namespace ProyectoFinal5
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            inventario = new ObservableCollection<Producto>(dataAccess.GetAllDapper());
            movimientosCaja = new ObservableCollection<MovimientoCaja>(dataAccess.GetAllMovimientosCaja());
